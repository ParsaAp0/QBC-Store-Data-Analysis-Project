...
all_params_path = Path(
	"src/ML/models/regression/xgboost_model_all_parameters.json")
best_params_path = Path(
	"src/ML/models/regression/xgboost_model_best_parameters.json")


class XGBRegressorModel(model_interface):
	def __init__(self):
